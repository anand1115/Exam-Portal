...
if(isset($_POST['submit'])) {
	...
	$query = "UPDATE questions SET question = '$question' , answer1 = '$choice1' , answer2= '$choice2' , answer3 = '$choice3' , answer4 = '$choice4' , correct_answer = '$correct_answer' WHERE questionno = '$questionno' ";
	$run = mysqli_query($con , $query) or die(mysqli_error($con));
			...
			<div class="container">
				<form method="post" action="">
					...
					<p>
						...
						<input type="text" name="choice1" required="" value="<?php echo $answer1; ?>">
					</p>
					<p>
						<label>Option 2</label>
						<input type="text" name="choice2" required="" value="<?php echo $answer2; ?>">
					</p>
					<p>
						<label>Option 3</label>
						<input type="text" name="choice3" required="" value="<?php echo $answer3; ?>">
					</p>
					<p>
						<label>Option 4</label>
						<input type="text" name="choice4" required="" value="<?php echo $answer4; ?>">
					</p>
					<p>
